...
# I want to normalize my raw gene counts (TPM) and add together COG groups specifically
...
# Generate tpm matrix
all(rownames(bpcts) == gl$GeneID)
bptpm <- as.data.frame(tpm(bpcts, gl$Length))
...
aasub <- as.data.frame(aa[c(18,21,39,40,41),])
...
write_tsv(cogtable_gen, "/Users/colleenahern/Documents/Magda_BPs_experiment/metatranscriptomics/MT_grouped_reads/cogtable_tpm_05142025.tsv")
write_tsv(cogtable_gen, "/Users/colleenahern/Documents/Magda_BPs_experiment/metatranscriptomics/MT_grouped_reads/COGtable_tpm_11102025.tsv")
#These ^ are the same I just saved it just in case
cogtable_genr <- read_tsv("/Users/colleenahern/Documents/Magda_BPs_experiment/metatranscriptomics/MT_grouped_reads/cogtable_tpm_05142025.tsv")
cogtable_genr <- read_tsv("/Users/colleenahern/Documents/Magda_BPs_experiment/metatranscriptomics/MT_grouped_reads/COGtable_tpm_11102025.tsv")
...
write_tsv(cogtable_gen_avg, "/Users/colleenahern/Documents/Magda_BPs_experiment/metatranscriptomics/MT_grouped_reads/COGtable_tpm_avg_11102025.tsv")
########################################################################################################################
## Make heatmap
## BP: Import metadata file

## BP: TPM-normalized transcripts -- COGs added together
