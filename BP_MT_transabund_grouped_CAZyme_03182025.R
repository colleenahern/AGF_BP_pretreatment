...
# Finalized script for normalizing my raw gene counts and add together CAZyme type instead of COGs/KEGG modules
...
library(readxl)
dbcantable_genror <- as.data.frame(read_excel('/Users/colleenahern/Documents/Magda_BPs_experiment/metatranscriptomics/MT_grouped_reads/dbcantable_gen.xlsx'))
rownames(dbcantable_genror) <- dbcantable_genror$...1
dbcantable_genror <- dbcantable_genror[, -1]
